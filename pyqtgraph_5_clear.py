...
class MainWindow(QtWidgets.QMainWindow):
	def __init__(self):
		...
		# clearing the plot
		# if we want to clear and refresh the plot periodically:
		self.graphWidget.clear()
		# this will remove the lines from the plot but keep all other 
		# attributes the same

		self.plot(hour, temperature_2, 'Sensor 2', 'y')
