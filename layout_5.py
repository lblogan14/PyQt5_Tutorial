...
class MainWindow(QMainWindow):
	def __init__(self):
		...
		self.setWindowTitle('My spacing app')
		...
		# set the spacing around the entire layout
		layout1.setContentsMargins(0,0,0,0)
		# set spacing between elements inside layout
		...
		# add layout1 as the final composed layout
		widget = QWidget()
